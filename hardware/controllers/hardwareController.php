...
class hardwareController extends controllerClass
{
    ...
    public function __construct()
    {
        ...
        if($_REQUEST['opcion']=='hardwareMenuIntegrin')
        {
            $this->view->hardwareMenuIntegrin();
        }
        if($_REQUEST['opcion']=='hardwareMenuGenerarArchivo')
        {
            $this->view->hardwareMenuGenerarArchivo();
        }
