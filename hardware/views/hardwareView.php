...
class hardwareView extends vista
{
    ...
    public function hardwareMenuIntegrin()
    {
        ?>
        <div  style="padding:5px;">
            <!-- <div class="col-lg-2"></div>
    ...
    public function hardwareMenuGenerarArchivo()
    {
        ?>
        <div  style="padding:5px;">
            <!-- <div class="col-lg-2"></div>
            ...
            <div  class="row" id="botones" class="mt-3 " >
                ...
                <div class="col-lg-2">
                    <button type="button" 
                    class="btn btn-primary  float-right" 
                    onclick="formularioSubirArchivo123()"
                    >
                        Generar Excell
                    </button>
                </div>
    ...
    public function mostrarTraducciones()
    {
        ...
        <thead>
            ...
            <th scope="col">Nconcepto</th>
            <th scope="col">C.C. WORLD OFFICE
            </th>
            </tr>
        </thead>
        <tbody>
            <tr>
            <th scope="row">1</th>
            <td>FACTURACION ACUEDUCTO
            </td>
            <td>Cargo Fijo Acueducto
            </td>
            <td>43211001
            </td>
            </tr>
            ...
            <tr>
            <th scope="row">2</th>
            <td>FACTURACION RIEGO
            </td>
            <td>SERVICIO VIGILANCIA
            </td>
            <td>42109001
            </td>
            </tr>
    ...
    public function mostrarIntegrin()
    {
        ?>
          <table class="table">
        <thead>
            <tr>
            <th scope="col">#</th>
            <th scope="col">Codpredio</th>
            <th scope="col">Nombre</th>
            <th scope="col">Uso</th>
            <th scope="col">Estrato</th>
            <th scope="col">Servicio</th>
            <th scope="col">Nservicio</th>
            <th scope="col">Codigo_c</th>
            <th scope="col">Nconcep</th>
            <th scope="col">ult_0</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <th scope="row">1</th>
                <td>0010-1000-0000-00
                </td>
                <td>CORREDOR MARIA</td>
                <td>01</td>
                <td>01</td>
                <td>Ac</td>
                <td>Acueducto</td>
    ...
    public function mostrarGenerar()
    {
        ...
        <thead>
            ...
            <th scope="col">Tercero Interno</th>
            <th scope="col">Tercero Externo</th>
            <th scope="col">Encab Nota</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <th scope="row">1</th>
                <td>WORLD OFFICE PRUEBAS</td>
                <td>NC</td>
                <td>CM</td>
                <td>01</td>
                <td>01/01/2019</td>
